      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        ...
        >
          <ComposedChart data={chartData}>
            <defs>
              <linearGradient id="fillScope" x1="0" y1="0" x2="0" y2="1" strokeWidth={3}>
                <stop
                  offset="5%"
            ...
            <Area
              ...
              strokeWidth={1.5} 
            />
            <Line type="natural" dataKey="ideal" stroke="var(--color-ideal)" strokeDasharray="3 3" dot={false} strokeWidth={1.5} />
            <ChartLegend content={<ChartLegendContent />} />
          </ComposedChart>
        </ChartContainer>
      </CardContent>
      <ExpoChartFooter title="Scope creeps & slow down towards the end of the project" description="Require stronger push for lofty goals" />
    </Card>
  )
}
