...
describe('Task List View - Sorting', () => {
  it('should reorder tasks when a sort option is clicked', () => {
    cy.get('[data-testid="task-list-row"]').then(($rowsBefore) => {
      ...
      cy.get('[data-testid="task-list-row"]').then(($rowsAfter) => {
